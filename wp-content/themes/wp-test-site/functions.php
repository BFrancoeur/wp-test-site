<?php
/**
 * WP Test Site functions and definitions
 *
 ...
 */
function wp_test_site_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on WP Test Site, use a find and replace
		* to change 'wp-test-site' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'wp-test-site', get_template_directory() . '/languages' );
 ...
 */
function wp_test_site_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wp_test_site_content_width', 640 );
}
add_action( 'after_setup_theme', 'wp_test_site_content_width', 0 );
...
function wp_test_site_scripts() {
	...
	wp_enqueue_style(
		'dovetail-btn',
		get_template_directory_uri() . '/css/components/btn.css',
		[ 'dovetail-utilities' ],
		_S_VERSION
	);
	...
	wp_enqueue_style(
		'dovetail-hero',
		get_template_directory_uri() . '/css/components/hero.css',
		[ 'dovetail-btn' ],
		_S_VERSION
	);
	...
	wp_enqueue_style(
		'dovetail-testimonial',
		get_template_directory_uri() . '/css/components/testimonial.css',
		[ 'dovetail-utilities' ],
		_S_VERSION
	);
...
add_action( 'wp_enqueue_scripts', 'wp_test_site_scripts' );
